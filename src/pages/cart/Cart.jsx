...
function Cart() {
  ...
  const buyNow = async () => {
    ...
    // Save the order details to the 'orders' collection
    try {
      ...
      await addDoc(orderRef, {
        ...
        paymentId: 'N/A', // You can set this to 'N/A' or any value you prefer for non-payment orders.
      });

      // Clear the cart (you may need to dispatch an action to clear the Redux cart state as well)
      cartItems.forEach((item) => {
        dispatch(deleteFromCart(item));
      });

      // Notify the user that the order was successful
